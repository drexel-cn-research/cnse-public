...
2. cdn.prod.jointangerine.com
   - Type: CNAME
   - Points to: d345151b9v.cloudfront.net
   - Used for content delivery via CloudFront

3. api.prod.jointangerine.com
   - Type: CNAME
   - Points to: k8s-prod-tangerineapi-dadb6b-777205.us-east-2.elb.amazonaws.com
   - Used for API services via an ELB in us-east-2

4. data.prod.jointangerine.com
   - Has ACM validation record (_b71a8c417ba53d0.data.prod.jointangerine.com)
...
3. The CloudFront distributions (dr451b9v.cloudfront.net and others) provide an additional security layer by offering edge protection and caching.
