...
d) prod-db-activity-stream-lambda-role-0831f30
...
B. EKS CLUSTER NODES:
   * EKS nodes (i-0411f1d6539, i-0121ec9c9f)
     - Run in the tangerine_api_eks_cluster
     - Use IAM instance profile: eks-66c8a-c132-1f9b-663b6fe5de5a
...
2. Network security:
   - Database-accessing Lambda functions run within VPC (vpc-1f2c487581c155)
   - Security groups control network access (sg-0c535f8f28c421, sg-01b27eec5e9f4, etc.)
