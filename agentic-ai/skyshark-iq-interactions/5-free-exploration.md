...
1. EKS CLUSTER:
   ...
   - Version: 1.30
   - Status: ACTIVE
   - Running in VPC: vpc-1f2c48f581c155
...
3. NETWORKING:
   - Primary VPC: vpc-1f2c48f581c155 (CIDR: 172.30.0.0/16, 172.29.0.0/16)
   - Default VPC: vpc-d12ce4ee27f94 (CIDR: 172.31.0.0/16)
...
3. NETWORK SECURITY:
   - Default security group (sg-0d9db59241292e) allows all outbound traffic
...
1. Request access to AWS Management Console for the account (321424749059)
